var bunyan = require('bunyan')
  ...
  , createHandleClientRequests = require('./client-request-handler')

module.exports = function createSocketServer(serviceLocator) {

  var handleClientRequests =
    createHandleClientRequests(connectionHandler, captainRequestSender, serviceLocator)
